  ...
  return (
    <main className="details">
      <div
        ...
        style={{
          backgroundImage: `url(${
            gameDetail.screenshots ? gameDetail.screenshots[0].image : null
          })`,
        }}
      ></div>
      ...
      <div className="row-wrapper">
        <div className="add-info">
          <img
            src={
              gameDetail.screenshots ? gameDetail.screenshots[1].image : null
            }
          />
        ...
        {gameDetail.minimum_system_requirements ? (
          <div>
            <img
              src={
                gameDetail.screenshots ? gameDetail.screenshots[2].image : null
              }
            />
